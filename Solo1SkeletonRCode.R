...
numsub <- subset(numdata, select=c("q24r1","q24r2","q24r3","q25r1","q25r3","q25r5",
                                   "q26r8","q26r10","q26r12","q26r13","q26r16"))
a=table(numsub$q24r1)
a
barplot(a)

a=table(numsub$q26r16)
a
barplot(a)
...
combdata <- cbind(numsub,newdf,numdata$q1,numdata$q11,numdata$q12,numdata$q48,numdata$q49,
                  numdata$q50r1,numdata$q50r2,numdata$q50r3,numdata$q50r4,numdata$q50r5,
                  numdata$q54,numdata$q56,numdata$q57)
combdata2 <- cbind(numsub,newdf,numdata$q4r1,numdata$q4r2,numdata$q4r3,numdata$q4r4,numdata$q4r5,
                   numdata$q4r6,numdata$q4r7,numdata$q4r8,numdata$q4r9,numdata$q4r10,numdata$q4r11
                  )

combdata2 <- rename(combdata2, c(clusterresults.cluster="cluster2"))
...
clusters<-aggregate(combdata,by=list(byvar=combdata$cluster), mean)
write.csv(clusters, file = "clusters.csv")

clusters2<-aggregate(combdata2,by=list(byvar=combdata2$cluster2), mean)
write.csv(clusters2, file = "clusters2.csv")
...
clust1 <- subset(clust1, select=c("q24r1","q24r2","q24r3","q25r1","q25r3","q25r5",
                                  "q26r8","q26r10","q26r12","q26r13","q26r16"))
...
clust2 <- subset(clust2, select=c("q24r1","q24r2","q24r3","q25r1","q25r3","q25r5",
                                  "q26r8","q26r10","q26r12","q26r13","q26r16"))
...
clust3 <- subset(clust3, select=c("q24r1","q24r2","q24r3","q25r1","q25r3","q25r5",
                                  "q26r8","q26r10","q26r12","q26r13","q26r16"))
...
clust4 <- subset(clust4, select=c("q24r1","q24r2","q24r3","q25r1","q25r3","q25r5",
                                  "q26r8","q26r10","q26r12","q26r13","q26r16"))
...
clust5 <- subset(clust5, select=c("q24r1","q24r2","q24r3","q25r1","q25r3","q25r5",
                                  "q26r8","q26r10","q26r12","q26r13","q26r16"))
